# Gompertz 블록 모형으로 200번 모의한 VPC(12장과 같은 방법). 관측이 20마리뿐이라
# 띠가 넓다. 그래도 관측의 중앙값과 양 끝이 띠 안에 있는지는 볼 수 있다.
...
par(mar = c(4, 4, 1, 1))
plot(mid, oq[, 2], type = "n", ylim = c(0, 2500), xlab = "이식 후 일수",
     ylab = expression(부피~(mm^3)))
