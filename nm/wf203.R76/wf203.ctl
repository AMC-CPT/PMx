$PROB WARFARIN PK/PD SIMULTANEOUS, TURNOVER (KOUT STIMULATION, TYPE IV)   P:wf201  F:BASE
...
$PK
  ...
  SMAX = THETA(9)                          ; maximal stimulation of KOUT
  KIN  = BASE * KOUT
  KE   = CL / V
  S2   = V
  A_0(3) = BASE
...
$DES
  ...
  DADT(3) = KIN - KOUT * (1 + SMAX * CP / (C50 + CP)) * A(3)
